...
function Group32(props) {
  const { place, overlapGroup4, phone, overlapGroup5, vector2, text21, text20, contactWebuildCom } = props;
      ...
      <div className="flex-row-1">
        <div className="flex-col">
          <div className="map-pin-1">
            <div className="overlap-group-2" style={{ backgroundImage: `url(${overlapGroup4})` }}>
              <img
                className="vector-10"
          ...
          <div className="mail">
            <div className="overlap-group1" style={{ backgroundImage: `url(${overlapGroup5})` }}>
              <img className="vector-11" src={vector2} />
            </div>
          </div>
        </div>
        <div className="flex-col-1">
          <p className="text-6 typography-body-smalltext-14-regular">{text21}</p>
